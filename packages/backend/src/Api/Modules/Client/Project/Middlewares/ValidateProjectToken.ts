...
import { ERROR, INVITATION_EXPIRED, INVALID_TOKEN } from "Api/Modules/Common/Helpers/Messages/SystemMessages";

export const validateProjectToken = async (req: Request, res: Response, next: NextFunction) => {
